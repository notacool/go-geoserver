...
type LayerService interface {
	...
	PublishPostgisLayer(workspaceName string, datastoreName string, publishName string, tableName string, epsg string) (published bool, err error)
...
func (g *GeoServer) PublishPostgisLayer(workspaceName string, datastoreName string, publishName string, tableName string, epsg string) (published bool, err error) {
	if workspaceName != "" {
		workspaceName = fmt.Sprintf("workspaces/%s/", workspaceName)
	}
